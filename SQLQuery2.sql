...
insert into Empregado values ('Gesley', '15/01/18',18000.00);
insert into Empregado values ('Laura', '25/12/23', 15000.00);
insert into Empregado values ('Dalila', '05/06/20',12000.00);
insert into Empregado values ('Robson', '01/05/19',9000.00);
insert into Empregado values ('Luiz', '08/03/22',7000.00);
...
Select 'Funcionario: '+nome+' Salario: '+CONVERT(VARCHAR, salario), salario, nome from empregado;